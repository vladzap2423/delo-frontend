...
import { getAllUsers, updateUserPassword, updateUserRole, updateUserStatus, createUser } from "@/services/user.service";
...
export default function AdminPage() {
    ...
    return (
        <div className="p-8">
            <div className="flex">
                <h1 className="text-2xl font-bold mb-6 mr-6">Список пользователей</h1>
                <UserRoundPlus />
            </div>
