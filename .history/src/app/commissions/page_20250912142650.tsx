...
import {getAllCommissions, createCommission, addUsersToCommission, removeUserFromCommission,} from "@/services/commission.service";
            ...
            {commissions.map((c) => (
                ...
                <td className="px-4 py-2 border">
                    ...
                    <div className="relative">
                        ...
                        defaultValue=""
                        className="absolute right-0 top-10 border rounded px-2 py-1 bg-white shadow hidden"
                        >
                        <option value="" disabled>
                            Выберите пользователя
                        </option>
                        {activeUsers
                            .filter((u) => !c.users.find((cu) => cu.id === u.id))
                            .map((u) => (
