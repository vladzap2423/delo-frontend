...
// react-pdf требует указать воркер
      ...
      <div className="bg-white rounded-lg shadow-lg p-4 relative w-4/5 h-5/6 overflow-hidden">
        ...
        <div className="flex gap-4 h-[90%]">
          ...
          <div className="flex-1 border relative overflow-auto">
            <Document file={fileUrl} options={{useWorker: false}}>
            ...
            {slots.map((slot) => {
              ...
              return (
                ...
                >
                  <div ref={nodeRef} className="absolute px-2 py-1 bg-blue-500 text-white text-xs rounded cursor-move select-none">
                    {slot.fio}
                  </div>
                </Draggable>
              );
