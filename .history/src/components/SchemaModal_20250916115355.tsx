              ...
              return (
                ...
                >
                  <div
                    ref={nodeRef}
                    style={{
                      width: slot.width * pageWidth,
                      height: slot.height * pageHeight,
                    }}
                    className="absolute flex items-center justify-center bg-blue-500 text-white text-xs rounded cursor-move select-none"
                  >
                    {slot.fio}
                  </div>
                </Draggable>
