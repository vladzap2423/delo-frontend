...
export default function SignatureBlock({ fio, cert, date, preview }: SignatureBlockProps) {
  return (
    <div 
    className=" w-[220px] h-[90px] border-2 border-purple-700 rounded-lg bg-white shadow-md flex flex-col p-2 text-[11px] text-purple-800 overflow-hidden">
      ...
      <div className="flex items-center gap-2 mb-1">
        ...
        <span className="font-bold text-[9px] leading-tight">
          ДОКУМЕНТ ПОДПИСАН УСИЛЕННОЙ КВАЛИФИЦИРОВАННОЙ<br />ЭЛЕКТРОННОЙ ПОДПИСЬЮ
        </span>
      </div>
