...
export default function TaskPage() {
  ...
  return (
    <div className="h-[calc(100vh-99px)] grid grid-cols-3 gap-6 p-4 overflow-hidden">
      {/* В работе */}
    <div className="col-span-2 bg-white rounded-lg shadow p-4 flex flex-col h-full">
    ...
    {/* Отработано */}
    <div className="col-span-1 bg-white rounded-lg shadow p-4 flex flex-col h-full">
