...
export default function TaskPage() {
  ...
  const renderTaskCard = (task: Task) => (
    ...
    >
      ...
      {/* Создатель */}
        <div className="text-sm text-gray-500 text-right mt-auto">
          Создал: {task.creator.fio}
        </div>
        {/* Кнопка подписания */}
        <div>
            <button className="ml-2 px-3 py-1 text-sm bg-green-200 text-black rounded hover:bg-green-400">
                Открыть
            </button>
            <button className="ml-2 px-3 py-1 text-sm bg-blue-300 text-black rounded hover:bg-blue-500">
                Подписать
            </button>
        </div>
    </div>
      ...
      <div className="col-span-2 bg-white rounded-lg shadow p-4">
        <div className="flex justify-between items-center mb-4">
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 py-1 bg-emerald-500 text-white rounded-lg hover:bg-emerald-700"
          >
