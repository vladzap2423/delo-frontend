    ...
    >
      ...
      <div className="flex flex-col flex-1">
        ...
        <div className="flex flex-col">
            ...
            <button className="ml-2 px-3 py-1 text-sm bg-blue-300 text-black rounded-xl hover:bg-blue-500">
                Подписать
            </button>
            {/* Создатель */}
            <div className="text-sm text-gray-500 text-right mt-auto text-center">
