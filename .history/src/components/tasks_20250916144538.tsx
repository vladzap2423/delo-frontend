...
const SchemaModal = dynamic(() => import("@/components/SchemaModal"), {
  ssr: false,
});
...
export default function TaskPage() {
  ...
  const [signSchema, setSignSchema] = useState<
  {
    userId: number;
    page: number;
    x: number;
    ...
    <div className="grid grid-cols-3 gap-6">
      ...
      {showSchemaModal && file && (
        <SchemaModal
          ...
          onSave={({groupPos, groupSize, blockSize}) => {
            setSignSchema({groupPos, groupSize, blockSize});
